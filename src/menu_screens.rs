...
impl Plugin for MenuPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            OnEnter(MenuState::Settings(SettingsType::General)),
            settings_screen.run_if(in_state(GameState::MainMenu)),
        );
        app.add_systems(
            OnEnter(MenuState::Settings(SettingsType::Audio)),
            settings_screen.run_if(in_state(GameState::MainMenu)),
        );
        app.add_systems(
            OnEnter(MenuState::Settings(SettingsType::Controls)),
            settings_screen.run_if(in_state(GameState::MainMenu)),
        );
        ...
        app.add_systems(
            OnExit(MenuState::Settings(SettingsType::General)),
            despawn_menu,
        );
        app.add_systems(
            OnExit(MenuState::Settings(SettingsType::Audio)),
            despawn_menu,
        );
        app.add_systems(
            OnExit(MenuState::Settings(SettingsType::Controls)),
            despawn_menu,
        );
                ...
                .with_children(|parent| {
                    ...
                    parent
                        .spawn((
                            ...
                            BackgroundColor(NORMAL_BUTTON_COLOR),
                            BorderRadius::MAX,
                            NextStateDestination::Menu(MenuState::Settings(SettingsType::General)),
                        ))
                        .with_children(|parent| {
                            parent.spawn((
                                Text::new("Settings"),
...
fn settings_screen(
    ...
    menu_settings: Res<State<MenuState>>,
) {
    let font = asset_server.load("fonts/MatrixtypeDisplay-9MyE5.ttf");
    ...
    commands
        ...
        .with_children(|parent| {
                ...
                .with_children(|parent| {
                    ...
                    parent
                        .spawn((
                            ...
                            BackgroundColor(NORMAL_BUTTON_COLOR),
                            BorderRadius::MAX,
                            NextStateDestination::Menu(MenuState::Settings(SettingsType::Audio)),
                        ))
                        .with_children(|parent| {
                            parent.spawn((
                                Text::new("Audio"),
                    ...
                    parent
                        .spawn((
                            ...
                            BackgroundColor(NORMAL_BUTTON_COLOR),
                            BorderRadius::MAX,
                            NextStateDestination::Menu(MenuState::Settings(SettingsType::Controls)),
                        ))
                        .with_children(|parent| {
                            parent.spawn((
                                Text::new("Controls"),
            ...
            parent
                ...
                .with_children(|parent| match menu_settings.get() {
                    MenuState::Settings(SettingsType::General) => {
                        parent.spawn((
                            Text::new("General"),
                            TextFont {
                                font: font.clone(),
                    ...
                    MenuState::Settings(SettingsType::Audio) => {
                        parent.spawn((
                            Text::new("Audio"),
                            TextFont {
                                font: font.clone(),
                    ...
                    MenuState::Settings(SettingsType::Controls) => {
                        parent.spawn((
                            Text::new("Controls"),
                            TextFont {
                                font: font.clone(),
